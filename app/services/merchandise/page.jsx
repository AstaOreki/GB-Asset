 ...
 *
 * TO ADD THE PRODUCT PHOTOS: drop the files into `public/image/` and add one
 * entry per photo below. Nothing else needs to change — the gallery lays
 ...
 *
 *   { src: "/image/merch-gift-set.jpg", alt: "GBA Custom Gold Gift Set" }
 */
