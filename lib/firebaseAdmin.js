...
// Payment receipts only — see storage.rules, which denies every client
// request outright, so this admin-credentialed bucket is the only way
// anything ever reads or writes a receipt file.
